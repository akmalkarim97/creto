...
function menu(){
	...
	echo " 
				...
				<div class='container'>
					<div class='top-panel-cover'>
						<ul class='header-cont'>
							...
							<li style='margin-right: 1px;'><a target='_blank' href='https://twitter.com/weststarmaxus'><i class='fa fa-twitter' aria-hidden='true'></i></a></li>
						...
						<ul class='icon-right-list'>
							<li><a class='header-like' href='assets/brochure/G10Exe_Ebroch.pdf' target='_blank'><i class='fa fa-file-text' aria-hidden='true'></i></a></li>
							<li><a class='header-user' href='testdrive.php'><i class='fa fa-car' aria-hidden='true'></i></a></li>
							<li><a class='header-user' href='bookservice.php'><i class='fa fa-wrench' aria-hidden='true'></i></a></li>
							<li><a class='header-user' href='askquestion.php'><i class='fa fa-question-circle' aria-hidden='true'></i></a></li>
							<li><a class='header-user' href='tel:+60321433331'><i class='fa fa-phone' aria-hidden='true'></i></a></li>
							<li><a class='header-cart' href='mailto:admin@weststarmaxus.com'><i class='fa fa-envelope' aria-hidden='true'></i></a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class='container'>
				<a href='index.php' class='logo'><img src='assets/img/weststar-logo-black.png' width='200' alt='logo'></a>
				<nav class='nav-menu'>
					<ul class='nav-list'>
			...
			<div class='row footer-item-cover'>
				...
				<div class='footer-item col-md-5 col-lg-4'>
					...
					<ul class='footer-soc social-list'>
						...
						<li><a target='_blank' href='https://twitter.com/weststarmaxus'><i class='fa fa-twitter' aria-hidden='true'></i></a></li>
